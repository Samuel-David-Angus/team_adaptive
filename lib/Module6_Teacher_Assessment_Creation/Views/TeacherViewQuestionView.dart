...
class TeacherViewQuestionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TeacherQuestionViewModel viewModel = Provider.of<TeacherQuestionViewModel>(context, listen: false);
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ElevatedButton(
                          onPressed: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => TeacherAddQuestionView(lessonModel: lesson)));
                          },
